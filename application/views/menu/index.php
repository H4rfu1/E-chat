...
<div class="row">
  <div class="col-lg-6 table-responsive">
    ...
    <a href="#" class="btn btn-success mb-3"  data-toggle="modal" data-target="#newMenu">Add New Menu</a>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a class="badge badge-danger" style="color:white;" onclick="conDelete('<?= base_url("menu/delete_menu/"); echo $m['id']; ?>'); ">Delete</a>
          </td>
        </tr>
      <?php $i++; endforeach; ?>
      </tbody>
